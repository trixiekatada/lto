...
<div class="panel panel-info">
    <div class="panel-heading">
        <div class="panel-title">Renew License Form (Please Fill up correctly)</div>
    </div>  
    <div class="panel-body" >
        ...
        <form id="signupform" class="form-horizontal" role="form" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" name="nationality"  value="{{ old('nationality') }}" disabled>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" name="height" placeholder="" disabled>
                </div>
            </div>
            <div class="form-group">
                <label for="first_name" class="col-md-3 control-label">Weight</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" name="weight" placeholder="" disabled>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" name="TOA" value="Renewal">
                </div>
            </div>
              <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input type="text" class="form-control" name="mothername" placeholder="" value="{{ $data->motherName }}" disabled>
                </div>
            </div>
            <div class="form-group">
                <label for="password" class="col-md-3 control-label">Father's Name</label>
                <div class="col-md-9">
                    <input type="text" class="form-control" name="fathername" placeholder="" value="{{ $data->fatherName }}" disabled>
                </div>
            </div>
