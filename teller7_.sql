...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2016 at 11:35 AM
...
(53, 24, 12378, 3, 3, '2016-03-02 12:54:40', '2016-03-02 12:30:58', 0),
(54, 25, 12379, 2, 2, '2016-03-02 12:53:42', '2016-03-02 12:31:16', 0),
(55, 26, 12380, 1, 1, '2016-03-02 12:31:34', '2016-03-02 12:31:34', 0),
(56, 27, 12381, 1, 1, '2016-03-02 12:36:12', '2016-03-02 12:36:12', 0),
(57, 28, 12382, 1, 1, '2016-03-02 12:38:09', '2016-03-02 12:38:09', 0);
...
INSERT INTO `tbl_register_license` (`rl_id`, `first_name`, `last_name`, `address`, `nationality`, `gender`, `birthdate`, `height`, `weight`, `telno`, `TOA`, `TLA`, `DSA`, `EA`, `bloodtype`, `donor`, `civilstatus`, `hair`, `eyes`, `built`, `complexion`, `date`, `birthplace`, `mothername`, `fathername`, `client_id`, `created_at`, `updated_at`) VALUES
...
`transactions_id` int(11) NOT NULL,
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12383 ;
...
--
ALTER TABLE `tbl_queues`
MODIFY `queue_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=58;
--
-- AUTO_INCREMENT for table `tbl_register_license`
--
ALTER TABLE `tbl_register_license`
MODIFY `rl_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
